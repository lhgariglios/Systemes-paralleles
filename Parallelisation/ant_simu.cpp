...
int main(int argc, char* argv[])
{
    ...
    pos_x.resize(ants_per_proc);
    pos_y.resize(ants_per_proc);
    loaded.resize(ants_per_proc, false);
    seeds.resize(ants_per_proc);
