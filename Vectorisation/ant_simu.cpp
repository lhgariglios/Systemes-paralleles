...
int main(int nargs, char* argv[])
{
    ...
    pos_x.resize(nb_ants);
    pos_y.resize(nb_ants);
    loaded.resize(nb_ants, false);
    seeds.resize(nb_ants);
    ...
    Renderer renderer( land, phen, pos_nest, pos_food, pos_x, pos_y );
    ...
    while (cont_loop) {
        ...
        advance_time( land, phen, pos_nest, pos_food, pos_x, pos_y, loaded, seeds, food_quantity );
